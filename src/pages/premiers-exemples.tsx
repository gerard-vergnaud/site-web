...
const FirstExamples = () => {
  ...
  return (
    <TextListLayout
      ...
      texts={[
        {
          link: '/texts/gvergnaud_1987_fonction-action-symbolisation-enfant_psychologie.pdf',
          description:
        ...
        {
          link: '/texts/gvergnaud_1982_cognitive-tasks-operation_addition-subtraction.pdf',
          description:
        ...
        {
          link: '/texts/gvergnaud_1976_structures-additives_revue-francaise-pedagogie.pdf',
        ...
        {
          link: '/texts/gvergnaud_1994_quatre-operations-arithmetiques_nathan-enseigner-apprendre-comprendre.pdf',
          description:
        ...
        {
          link: '/texts/gvergnaud_2007_malices-soustraction_vita-scolastica.pdf',
          description: 'Les malices de la soustraction',
          title:
            "2007 in Vita Scolastica, traduit en italien avec Bruno D'amore",
        },
        {
          link: '/texts/gvergnaud_1983_multiplicative-structures_acquisition-mathematics.pdf',
        ...
        {
          link: '/texts/gvergnaud_1998_arithmetique-algebre_colloque-rethymnon.pdf',
          description:
        ...
        {
          link: '/texts/gvergnaud_2011_activites-familieres-creatives_colloque-lebahar.pdf',
          description:

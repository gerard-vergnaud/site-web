      ...
      texts={[
        {
          ...
          link: getLink(
            '/texts/gvergnaud_2008_discipline-didactique-professionnelle_travail-apprentissage-1.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_2008_culture-conceptualisation_carrefours-education-26.pdf'
          ),
        },
        {
          ...
          link: getLink(
            '/texts/gvergnaud_1995_introduction-competences_crin.pdf'
          ),
        },
        {
          ...
          link: getLink(
            '/texts/gvergnaud_2002_comment-apprend-on_personnel-former-autrement-430.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_1992_didactique-formation-adultes-peu-qualifies_education-permanente-111.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_2000_formation-enseignants-formateurs_carrefours-education-10.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_1992_rapport-synthese_colloque-adultes-peu-qualifies.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_1987_difficultes-individuelles_groupe-travail-bas-niveau-qualification.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_2008_contribution-debat_analyser-comprendre-pratique-enseignante.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_2007_nouvelles-figures_colloque-rubinstein.pdf'
          ),
        },
      ]}
    />

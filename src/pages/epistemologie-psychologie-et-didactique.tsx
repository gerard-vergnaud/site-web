      ...
      texts={[
        {
          ...
          link: getLink(
            '/texts/gvergnaud_1988_quelques-enjeux-scientifiques_colloque-tours.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_1987_enseignements-theoriques_colloque-clermont-ferrand.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_2000_recherche-didactique-epistemologie_psychologie-enfances-cultures-educations-137.pdf'
          ),
        },
        {
          ...
          link: getLink(
            '/texts/gvergnaud_2012_epistemologie-psychologie_rencontre-nancy.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_2000_quelles-contributions_colloque-sfax.pdf'
          ),
        },
        {
          ...
          link: getLink(
            '/texts/gvergnaud_2009_couple-situation-scheme_symposium-nantes.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_1999_situation-scheme-cle-de-voute_symposium-sherbrooke.pdf'
          ),
        },
      ]}
    />

      ...
      texts={[
        {
          ...
          link: getLink(
            '/texts/gvergnaud_2010_forme-operatoire-predicative_conference-aracaju.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_2016_signifiants-langagiers-symboliques_conference-bonito.pdf'
          ),
        },
        {
          ...
          link: getLink(
            '/texts/gvergnaud_1996_fond-action-conceptualisation_savoirs-theoriques-savoirs-action.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_1993_signifiants-signifies_sciences-education-1-3.pdf'
          ),
        },
        {
          ...
          link: getLink(
            '/texts/gvergnaud_2004_pourquoi-bruit-competence_snes-nouveauxregards-24.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_1999_forme-operatoire-connaissance_entreprises-competences-crin.pdf'
          ),
        },
        {
          ...
          link: getLink(
            '/texts/gvergnaud_2000_scheme-est-il-mort_colloque-eps-inrp.pdf'
          ),
        },
      ]}
    />

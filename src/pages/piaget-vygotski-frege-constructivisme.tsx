      ...
      texts={[
        {
          ...
          link: getLink(
            '/texts/gvergnaud_1999_a-propos-de-frege_seminaire-sfida-nice.pdf'
          ),
        },
        {
          ...
          link: getLink(
            '/texts/gvergnaud_1996_education-best-piaget-heritage_swiss-journal-psychology-55.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_1996_idees-fondamentales-piaget-didactique_perspectives-26.pdf'
          ),
        },
        {
          ...
          link: getLink(
            '/texts/gvergnaud_2001_piaget-visite-didactique_intellectica-33-2.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_1989_relire-vygotski_enfance-42_-1-2.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_2007_heritage-vygotski_colloque-albi.pdf'
          ),
        },
        {
          ...
          link: getLink(
            '/texts/gvergnaud_1987_colloque-constructivisme_montreal.pdf'
          ),
        },
      ]}
    />

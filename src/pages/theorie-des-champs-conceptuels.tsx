      ...
      texts={[
        {
          ...
          link: getLink(
            '/texts/gvergnaud_1988_theoretical-frameworks_icme-6-budapest.pdf'
          ),
        },
        {
          ...
          link: getLink(
            '/texts/gvergnaud_1990_theorie-champs-conceptuels_recherche-didactique-mathematiques-10-2-3.pdf'
          ),
        },
        {
          ...
          link: getLink(
            '/texts/gvergnaud_2009_activite-developpement-representation_colloque-paris.pdf'
          ),
        },
        {
          ...
          link: getLink(
            '/texts/gvergnaud_2009_theory-conceptual-fields_human-development-52.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_2011_pensee-geste_enfance-c-sorsana-63-1.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_1991_morphismes-fondamentaux_sciences-cognitives-debat.pdf'
          ),
        },
      ]}
    />

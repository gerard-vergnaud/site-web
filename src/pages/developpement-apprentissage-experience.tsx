      ...
      texts={[
        {
          ...
          link: getLink(
            '/texts/gvergnaud_2010_long-terme-court-terme_colloque-curitiba.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_1988_apprentissage-algebre_colloque-franco-allemand.pdf'
          ),
        },
        {
          ...
          link: getLink(
            '/texts/gvergnaud_2002_qu-est-ce-qu-apprendre_colloque-iufm-creteil.pdf'
          ),
        },
        {
          ...
          link: getLink(
            '/texts/gvergnaud_1999_developpement-cognitif-adulte_sciences-techniques-formation.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_1988_competences-mathematiques-maternelle_congres-agiem-toulouse-60.pdf'
          ),
        },
        {
          ...
          link: getLink(
            '/texts/gvergnaud_1988_questions-vives-developpement_bulletinpsychologie-390.pdf'
          ),
        },
        {
          description:
          ...
          link: getLink(
            '/texts/gvergnaud_2017_placement-donnees-droite_colloque-belfort.pdf'
          ),
        },
      ]}
    />
